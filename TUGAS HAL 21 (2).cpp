...
int main()
{
		...
		if((keluarjam - masukjam)<0) {selisihjam = ( 24 + keluarjam ) - masukjam ;
		}
		else {selisihjam = keluarjam - masukjam ;
		}
		
		//menghitung selisih menit
		if((keluarmenit - masukmenit)<0) {selisihmenit = ( 60 + keluarmenit ) - masukmenit ;
		}
		else {selisihmenit = keluarmenit - masukmenit ;
		}
		
		//menghitung selisih detik
		if((keluardetik - masukdetik)<0) {selisihdetik = ( 60 + keluardetik ) - masukdetik ;
		}
